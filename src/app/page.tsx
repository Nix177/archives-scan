        ...
        config: {
          ...
          responseSchema: {
            ...
            properties: {
              ...
              date_estimee: { type: Type.STRING, description: "Une date ou époque estimée (ex: Années 1920, XIXe siècle, etc.). Mettre 'Inconnue' si impossible à deviner." },
              ...
              pistes_recherche: { type: Type.STRING, description: "Conseils et recommandations d'outils pour que l'utilisateur puisse vérifier ces informations." }
            },
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <nav className="flex items-center justify-between px-6 md:px-8 py-6 border-b border-[#1a1a1a]/10 bg-[#fdfcfb] shrink-0">
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm uppercase tracking-widest font-medium opacity-60">
          <span>Historique</span>
          <span className="text-[#1a1a1a] opacity-100 border-b border-[#1a1a1a]">Nouvelle Analyse</span>
        </div>
      </nav>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <div className="col-span-1 md:col-span-2">
                      ...
                      <input 
                        type="text" 
                        name="titre"
                        value={archiveData.titre}
                        onChange={handleInputChange}
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none font-serif text-xl" 
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        type="text" 
                        name="categorie"
                        value={archiveData.categorie}
                        onChange={handleInputChange}
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm" 
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        type="text" 
                        name="date_estimee"
                        value={archiveData.date_estimee}
                        onChange={handleInputChange}
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm" 
                      />
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2">
                      ...
                      <textarea 
                        ...
                        onChange={handleInputChange}
                        rows={3} 
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm resize-none" 
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        type="text" 
                        name="createur_artiste"
                        value={archiveData.createur_artiste}
                        onChange={handleInputChange}
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm" 
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        value={archiveData.etat_conservation}
                        onChange={handleInputChange}
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm" 
                      />
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2">
                      ...
                      <textarea 
                        name="notes_historiques"
                        value={archiveData.notes_historiques}
                        onChange={handleInputChange}
                        rows={3} 
                        className="w-full bg-transparent border-b border-[#1a1a1a]/20 py-2 focus:border-[#1a1a1a] outline-none text-sm resize-none" 
                      />
